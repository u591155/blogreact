    ...
    <SideNavigation />       
        <div className="col-sm col-md col-lg mt-5" id="postSection">
            ...
            <h3>A Scope In Local Life</h3>
                ...
                but these does not mean that money isn’t important since it is the tool use for all trades. In a very simple economy lesson the economy is: you go to the store and you want something... 
